...
def data():
	...
	k1=Entry(root,width=10,bg="chocolate")
	k1.place(x=170,y=650)
	
	z1=Label(root,width=1,bg=v1)
	z1.place(x=190,y=650)
	
	z2=Label(root,width=1,bg=v2)
	z2.place(x=220,y=650)
	
	z3=Label(root,width=1,bg=v3)
	z3.place(x=250,y=650)
	
	z4=Label(root,width=1,bg=v4)
	z4.place(x=280,y=650)
	...
	messagebox.showinfo("Color Code ",code)
